...
```{r}
plot_gene(tpm_B73_top[1,]$gene)
plot_gene(tpm_B73_top[2,]$gene)
plot_gene(tpm_B73_top[3,]$gene)
```
...
Zm00001d052931
```{r}
plot_gene("Zm00001d052931")
```


```{r}
plot_gene(tpm_TIL01_top[1,]$gene)
plot_gene(tpm_TIL01_top[2,]$gene)
plot_gene(tpm_TIL01_top[500,]$gene)
```
...
Zm00001d050635
```{r}
plot_gene("Zm00001d050635")
lfc %>% filter(gene == "Zm00001d050635")
```

Zm00001d028541
```{r}
plot_gene("Zm00001d028541")
lfc %>% filter(gene == "Zm00001d028541")
```

Zm00001d052340
```{r}
plot_gene("Zm00001d052340")
lfc %>% filter(gene == "Zm00001d052340")
```

Zm00001d017699
```{r}
plot_gene("Zm00001d017699")
...
```{r}
plot_gene("Zm00001d003796")
plot_gene("Zm00001d011183")
```
...
```{r}
plot_gene(dunno[1,]$gene)
plot_gene(dunno[2,]$gene)
plot_gene(dunno[500,]$gene)
plot_gene(dunno[5000,]$gene)
```
