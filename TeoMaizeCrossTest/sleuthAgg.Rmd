...
```{r, eval=FALSE}
plot_bootstrap(leaf_so, sleuth_sig_B73[1,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[2,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[3,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[4,]$target_id, units="est_counts", color_by="cultivar")
```

Some less sig output

```{r, eval=FALSE}
plot_bootstrap(leaf_so, sleuth_sig_B73[500,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[600,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[700,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[1900,]$target_id, units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, sleuth_sig_B73[1500,]$target_id, units="est_counts", color_by="cultivar")
```
...
```{r, eval=FALSE}
plot_bootstrap(leaf_so, "Zm00001d029353_T001", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d029353_T002", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d029353_T004", units="est_counts", color_by="cultivar")
```

```{r, eval=FALSE}
plot_bootstrap(leaf_so, "Zm00001d026586_T001", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d026586_T002", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d026586_T003", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d026586_T004", units="est_counts", color_by="cultivar")
```
...
plot_bootstrap(leaf_so, "Zm00001d052108_T001", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d052108_T003", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d052108_T005", units="est_counts", color_by="cultivar")
plot_bootstrap(leaf_so, "Zm00001d052108_T006", units="est_counts", color_by="cultivar")
```
